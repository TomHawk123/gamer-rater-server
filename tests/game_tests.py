...
from raterapi.views.games import GameSerializer, CreateGameSerializer


class GameTests(APITestCase):

    # Add any fixtures you want to run to build the test database
    fixtures = ['users', 'tokens', 'categories', 'gameCategories', 'games',
                'gamers', 'pictures', 'ratings', 'reviews']
